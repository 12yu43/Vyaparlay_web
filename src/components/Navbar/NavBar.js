...
const NavBar = () => {
    ...
    return (
        <nav className={`fixed top-0 w-full z-30 transition duration-300 ease-in-out mb-16 ${!top && 'bg-blue-200 shadow-lg'}`}>
            <div className="flex flex-row justify-between items-center py-2 bg-[#99b9f5] ">
                <div className="flex flex-row justify-center md:px-12 md:mx-12 items-center text-center font-semibold ">
                <img src={logo} alt="logo" className="w-40 h-20"/>   
                    {/* <HashLink smooth to="/#hero">
                    <img src={logo} alt="logo" className="h-full w-44" />
                                            <h1 className="font-extrabold text-4xl text-blue-900">Vyaparlay</h1>
                        </HashLink> */}
                </div>
